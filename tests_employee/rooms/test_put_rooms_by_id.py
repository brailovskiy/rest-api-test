...
class TestPutRoomsByIdEmployee:
    """ Тесты категории Rooms, метод GET /rooms/id, роль - сотрудник """
    def test_put_rooms_by_id_by_employee(self, use_session_employee, check_in_room_number):
        """ Тест изменения данных номера сотрудником """
    ...
    def test_put_rooms_by_id_in_not_your_hotel_by_employee(self, use_session_employee):
        """ Тест попытки изменить данные в номере не в своей гостинице сотрудником """
