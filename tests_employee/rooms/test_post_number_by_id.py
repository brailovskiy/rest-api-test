...
class TestPostCheckInEmployee:
    """ Тесты категории Rooms, метод POST /id/number, роль - сотрудник """
    def test_change_room_number_by_employee(self, use_session_employee, free_room_number):
        """ Тест изменения номера комнаты сотрудником """
    ...
    def test_change_room_number_in_another_hotel_by_employee(self, use_session_employee):
        """ Тест попытки изменить номер комнаты в другой гостинице сотрудником """
    ...
    def test_change_room_number_to_incorrect_room_by_employee(self, use_session_employee):
        """ Тест попытки изменить номер комнаты в несуществущем номере сотрудником """
