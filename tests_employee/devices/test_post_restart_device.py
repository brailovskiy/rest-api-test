...
class TestPostRestartDeviceEmployee:
    """ Тесты категории devices, метод POST /device_slots/{id}/restart, роль - сотрудник """
    def test_post_restart_device_stb_by_employee(self, use_session_employee):
        """ Тест перезагрузки устройства STB сотрудником """
    ...
    def test_post_restart_device_smart_tv_by_employee(self, use_session_employee):
        """ Тест попытки перезагрузки устройства Smart TV сотрудником """
    ...
    def test_post_restart_unknown_device_by_employee(self, use_session_employee):
        """ Тест попытки перезагрузки неизвестного устройства сотрудником """
        with allure.step('Запрос на перезагрузку неизвестного устройства (MAC не соответствует ни одному известному устройству'):
    ...
    def test_post_restart_empty_slot_by_employee(self, use_session_employee):
        """ Тест попытки перезагрузки при пустом слоте сотрудником """
    ...
    def test_post_restart_null_device_by_employee(self, use_session_employee):
        """ Тест попытки перезагрузки устройства с несуществующим id сотрудником """
    ...
    def test_post_restart_device_in_another_hotel_by_employee(self, use_session_employee):
        """ Тест попытки перезагрузки устройства STB не в своей гостинице сотрудником """
