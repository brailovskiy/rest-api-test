...
class TestGetPurchasesByIdAdminHotel:
    """ Тесты категории Rooms, метод GET /id/purchases, роль - администратор гостиницы """
    def test_get_purchases_by_id_by_admin_hotel(self, use_session_admin_hotel):
    ...
    def test_get_purchases_by_id_in_another_hotel_by_admin_hotel(self, use_session_admin_hotel):
    ...
    def test_get_purchases_by_incorrect_id_by_admin_hotel(self, use_session_admin_hotel):
