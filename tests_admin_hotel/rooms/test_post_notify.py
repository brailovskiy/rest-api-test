...
class TestPutUsersByIdAdminHotel:
    ...
    def test_post_notify_to_empty_room_by_admin_hotel(self, use_session_admin_hotel):
        """ Тест отправки нотификации без указания номера комнаты администратором гостиницы """
    ...
    def test_post_notify_to_incorrect_room_by_admin_hotel(self, use_session_admin_hotel):
        """ Тест отправки нотификации в несуществующую комнату администратором гостиницы """
    ...
    def test_post_notify_to_room_in_another_hotel_by_admin_hotel(self, use_session_admin_hotel):
        """ Тест отправки нотификации в комнату чужого отеля администратором гостиницы """
