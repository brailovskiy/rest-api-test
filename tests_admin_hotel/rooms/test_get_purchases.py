...
class TestGetPurchasesAdminHotel:
    """ Тесты категории Rooms, метод GET /purchases, роль - администратор гостиницы """
    ...
    def test_get_purchases_by_room_id_by_admin_hotel(self, use_session_admin_hotel):
    ...
    def test_get_purchases_by_room_id_in_another_hotel_by_admin_hotel(self, use_session_admin_hotel):
        """ Тест попытки получения списка покупок в номере чужого отеля администратором гостиницы """
    ...
    def test_get_purchases_by_incorrect_room_id_by_admin_hotel(self, use_session_admin_hotel):
        """ Тест попытки получения списка покупок в несуществующем номере администратором гостиницы """
