...
class TestPostCheckInAdminHotel:
    """ Тесты категории Rooms, метод POST /id/checkin, роль - администратор гостиницы """
    ...
    def test_check_in_to_another_hotel_by_admin_hotel(self, use_session_admin_hotel):
        """ Тест попытки заселения номера из другой гостиницы администратором гостиницы """
    ...
    def test_check_in_to_incorrect_room_by_admin_hotel(self, use_session_admin_hotel):
        """ Тест попытки заселения в несуществующий номер администратором гостиницы """
