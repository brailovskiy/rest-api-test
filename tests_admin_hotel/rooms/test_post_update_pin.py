...
class TestPostUpdatePinAdminHotel:
    """ Тесты категории Rooms, метод POST /id/update_pin, роль - администратор гостиницы """
    def test_update_pin_by_admin_hotel(self, use_session_admin_hotel, check_in_room_number):
    ...
    def test_update_pin_in_another_hotel_by_admin_hotel(self, use_session_admin_hotel):
    ...
    def test_update_pin_in_incorrect_room_by_admin_hotel(self, use_session_admin_hotel):
