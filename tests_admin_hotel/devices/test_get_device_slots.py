...
class TestGetDevicesAdminHotel:
    """ Тесты категории devices, метод GET /device_slots, роль - администратор гостиницы """
    def test_get_device_slots_by_admin_hotel(self, use_session_admin_hotel):
        """ Тест получения списка доступных слотов для привязки устройства """
    ...
    def test_get_device_slots_in_another_hotel_by_admin_hotel(self, use_session_admin_hotel):
        """ Тест попытки получения списка доступных слотов для привязки устройства не в своей гостинице """
        ...
        with allure.step('Проверки, что администратор гостиницы не может получить просмотреть устройства в чужой '
                         'гостинице'):
